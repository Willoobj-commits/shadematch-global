...
- Built signed Android App Bundle - validated 2026-09-01 - artifact at `D:\shade_match_global_flutter\build\app\outputs\bundle\release\app-release.aab` (50,926,664 bytes, sha256 171549d3087f1e9124b42bbf652318bc0bb6ff06872a7115dd4d7825a95327ce); `jarsigner -verify` reports `jar verified`, signed by the `upload` key. Rebuilt from clean 2026-09-01 (`flutter clean` + `pub get` + `flutter build appbundle --release`, Flutter 3.47.1) and reproduced byte-identically.
