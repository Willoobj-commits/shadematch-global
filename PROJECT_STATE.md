...
- Built signed Android App Bundle - validated 2026-09-01 - artifact at `D:\shade_match_global_flutter\build\app\outputs\bundle\release\app-release.aab` (50,958,889 bytes, sha256 f66fa7390e70a49d2daa97d87a74eddf75c6f049d8a7bc10ad7dee999bd7cf42); `jarsigner -verify` reports `jar verified`, signed by the `upload` key. Rebuilt from clean 2026-09-01 (`flutter clean` + `pub get` + `flutter build appbundle --release`, Flutter 3.47.1) after the launcher icon was replaced - the shade-wheel icon is confirmed present at `base/res/mipmap-*/ic_launcher.png` inside the bundle. Supersedes the earlier 50,926,664-byte build (sha256 171549d3...), which still carried Flutter's stock icon - do not upload that one.
